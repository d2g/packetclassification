...
func init() {
	mypattern := Pattern{}
	mypattern.Name = "bittorrent"
	mypattern.RegularExpresion = "(?i)" + "^(\\x13bittorrent protocol|azver\\x01$|get /scrape\\?info_hash=get /announce\\?info_hash=|get /client/bitcomet/|GET /data\\?fid=)|d1:ad2:id20:|\\x08'7P\\)[RP]"
