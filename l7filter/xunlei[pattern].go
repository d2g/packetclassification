...
func init() {
	mypattern := Pattern{}
	mypattern.Name = "xunlei"
	mypattern.RegularExpresion = "(?i)" + "^([()]|get)(...?.?.?(reg|get|query)|.+User-Agent: (Mozilla/4\\.0 \\(compatible; (MSIE 6\\.0; Windows NT 5\\.1;? ?\\)|MSIE 5\\.00; Windows 98\\))))|Keep-Alive\\x0d\\x0a\\x0d\\x0a[26]"
