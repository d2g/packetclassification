...
func init() {
	mypattern := Pattern{}
	mypattern.Name = "http-rtsp"
	mypattern.RegularExpresion = "(?i)" + "^(get[\\x09-\\x0d -~]* Accept: application/x-rtsp-tunnelled|http/(0\\.9|1\\.0|1\\.1) [1-5][0-9][0-9] [\\x09-\\x0d -~]*a=control:rtsp://)"
